        ...
        return (
            <section className="home">
                ...
                <div className="container">
                    <div className="home-4" >
                        ...
                        <div className="row justify-content-between  " >
                            ...
                            <div className="col-4 card"><AiOutlineCar className="icon-home" />
                            ...
                            <div className="col-4 card"><GiClothes className="icon-home" />
                                <p class="card-text">
                ...
                <div className="home-3 container " >
                    ...
                    <div className="row">
                        <div className="col">
                            <img src={process.env.PUBLIC_URL + `/img/Home/home1.webp`} class="border-button"></img>
                        </div>

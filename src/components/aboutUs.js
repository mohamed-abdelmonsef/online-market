...
import first from '../components/img/Aboutus.jpg'
import second from '../components/img/Aboutus2.webp'
import third from '../components/img/Aboutus3.webp'
import fourth from '../components/img/pers1.jpg'
import fifth from '../components/img/pers2.jpg'
                ...
                <div class="bg-light">
                    <div class="container py-5">
                        <div class="row h-100 align-items-center py-5">
                            ...
                            <div class="col-lg-6 d-none d-lg-block"><img src={first} alt="" class="img-fluid" /></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white py-5">
                    <div class="container py-5">
                        <div class="row align-items-center mb-5">
                            ...
                            <div class="col-lg-5 px-5 mx-auto order-1 order-lg-2"><img src={second} alt="" class="img-fluid mb-4 mb-lg-0" /></div>
                        </div>
                        <div class="row align-items-center">
                            <div class="col-lg-5 px-5 mx-auto"><img src={third} alt="" class="img-fluid mb-4 mb-lg-0" /></div>
                    ...
                    <div class="container py-5">
                        ...
                        <div class="row text-center">
                            ...
                            <div class="col-xl-3 col-sm-6 mb-5">
                                <div class="bg-white rounded shadow-sm py-5 px-4"><img src={fourth} alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm" />
                            ...
                            <div class="col-xl-3 col-sm-6 mb-5">
                                <div class="bg-white rounded shadow-sm py-5 px-4"><img src={fifth} alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm" />
                            ...
                            <div class="col-xl-3 col-sm-6 mb-5">
                                <div class="bg-white rounded shadow-sm py-5 px-4"><img src={sixth} alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm" />
                            ...
                            <div class="col-xl-3 col-sm-6 mb-5">
                                <div class="bg-white rounded shadow-sm py-5 px-4"><img src={seventh} alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm" />

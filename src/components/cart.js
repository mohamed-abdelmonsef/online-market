            ...
            return (
                <>
                    ...
                    <div class="container padding-bottom-3x mb-1">
                        {
                            <div style={this.state.logged ? {} : { display: 'none' }} className="alert alert-success text-center">
                        ...
                        <div class="shopping-cart-footer">
                            <div class="column"><Link to="/"><button class="btn btn-outline-secondary" > Back to Shopping</button></Link></div>
                            <div class="column">
                                {isLogged
                                    ? <a onClick={() => { console.log('done'); }} class="btn btn-success" href="#">Checkout</a>
